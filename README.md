...
[![Build Status](https://travis-ci.org/ParspooyeshFanavar/gogen-avro.svg?branch=master)](https://travis-ci.org/ParspooyeshFanavar/gogen-avro)
[![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://raw.githubusercontent.com/ParspooyeshFanavar/gogen-avro/master/LICENSE)
[![Version 5.2.0](https://img.shields.io/badge/version-5.2.0-lightgrey.svg)](https://gopkg.in/ParspooyeshFanavar/gogen-avro.v5)
...
```
go get -d github.com/ParspooyeshFanavar/gogen-avro
```

Then run:

```
go install github.com/ParspooyeshFanavar/gogen-avro/gogen-avro
```

Or download and install a fixed release from gopkg.in:

```
go get -d gopkg.in/ParspooyeshFanavar/gogen-avro.v5
go install gopkg.in/ParspooyeshFanavar/gogen-avro.v5/gogen-avro
```
...
You can also use a `go:generate` directive in a source file ([example](https://github.com/ParspooyeshFanavar/gogen-avro/blob/master/test/primitive/schema_test.go)):
...
[Godocs for the container package](https://godoc.org/github.com/ParspooyeshFanavar/gogen-avro/container)
...
go generate github.com/ParspooyeshFanavar/gogen-avro/example

# Install the example projects on the gopath
go install github.com/ParspooyeshFanavar/gogen-avro/example/record
go install github.com/ParspooyeshFanavar/gogen-avro/example/container
```
